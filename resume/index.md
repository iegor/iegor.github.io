...
summ: >
  ...
  <br/>Designed, implemented, released and maintained healthy amount of programs
  ranging from a simple “one-file” tools
  up to complex multi-project software packages,
  ...
  <br/>Have experience leading a team of software developers.
modo: >
  Love solving complex tasks, tinkering with devices, riding bikes,
  sitting near the bonfire and thinking.
  ...
  <br/>Enjoy to drive given tasks above and beyond expectations.
contact:
